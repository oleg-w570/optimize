...
def async_alg_operational_characteristic_for_grishagin(n:int, r: float, eps: float):
...
if __name__ == "__main__":
    async_alg_operational_characteristic_for_grishagin(4, 4, 0.01)